...
# path = './food_nutrition/'
data=pd.read_csv('backend\\food_nutrition\\food.csv')
...
def Weight_Loss(age, veg, bmi):
    ...
    datafin=pd.read_csv('backend\\food_nutrition\\nutrition_distriution.csv')
...
def dietFunction(age, veg, weight, height):
    pred = ""
    ...
    print("Your body mass index is: ", bmi)
    if ( bmi < 18.5):
        pred = (Weight_Gain(age=age, veg=veg, bmi=bmi))
        body_type = "Underweight"
        # return pred
    elif ( bmi >= 18.5 and bmi < 25):
        pred = (Healthy(age=age, veg=veg, bmi=bmi))
        body_type = "Healthy"
        # return pred
    elif ( bmi >=25):
        pred = (Weight_Loss(age=age, veg=veg, bmi=bmi))
        body_type = "Overweight"
        # return pred
    
    return bmi, body_type, pred



# print(dietFunction(age=22, veg=1, weight=50, height=153))